...
describe('Enhanced Task Manager Tools', () => {
  ...
  describe('TaskCreateTool', () => {
    it('should create task with required fields', async () => {
      const tool = new TaskCreateTool(persistence);
  ...
  describe('TaskListTool', () => {
    beforeEach(async () => {
      // Create test tasks
      const createTool = new TaskCreateTool(persistence);
    ...
    it('should list my tasks', async () => {
      const tool = new TaskListTool(persistence);
    ...
    it('should include completed tasks when requested', async () => {
      const tool = new TaskListTool(persistence);
      const updateTool = new TaskUpdateStatusTool(persistence);
  ...
  describe('TaskUpdateStatusTool', () => {
    ...
    it('should update task status', async () => {
      const tool = new TaskUpdateStatusTool(persistence);
  ...
  describe('TaskReassignTool', () => {
    ...
    it('should reassign task to another agent', async () => {
      const tool = new TaskReassignTool(persistence);
      ...
      expect(result.isError).toBe(false);
      expect(result.content?.[0]?.text).toContain('Reassigned');
  ...
  describe('TaskAddNoteTool', () => {
    ...
    it('should add note to task', async () => {
      const tool = new TaskAddNoteTool(persistence);
  ...
  describe('TaskViewTool', () => {
    ...
    beforeEach(async () => {
      ...
      // Add some notes
      const noteTool = new TaskAddNoteTool(persistence);
    ...
    it('should view task details', async () => {
      const tool = new TaskViewTool(persistence);
