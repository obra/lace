// ABOUTME: Loading skeleton components with shimmer animations for different UI patterns
// ABOUTME: Includes text, card, avatar, timeline, and carousel skeleton variants
