// ABOUTME: Theme selector component with visual theme previews and persistence
// ABOUTME: Provides grid layout of available themes with color swatches and current selection indication
          ...
          >
            ...
            {currentTheme === theme.name && (
              <div className="absolute -top-1 -right-1 w-3 h-3 bg-primary rounded-full flex items-center justify-center">
                <div className="w-2 h-2 text-primary-content">✓</div>
              </div>
            )}
          </button>
        ))}
