// ABOUTME: Voice recognition UI components with audio level visualization
// ABOUTME: Includes full VoiceRecognitionUI component and compact voice button variant
