// ABOUTME: Swipeable card components with gesture-based interactions
// ABOUTME: Includes swipe cards, pull-to-refresh, floating action button, and long press components

'use client';

import { useState } from 'react';
import { motion, PanInfo, useMotionValue, useTransform } from 'framer-motion';
import { springConfig } from '~/interfaces/web/lib/animations';
