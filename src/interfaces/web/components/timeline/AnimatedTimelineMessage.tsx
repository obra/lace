// ABOUTME: Animated timeline message component with rich content rendering and smooth transitions
// ABOUTME: Handles different message types (admin, human, AI, tool, integration, carousel) with specialized animations
