// ABOUTME: Specialized carousel component for displaying code changes with file diffs and impact indicators
// ABOUTME: Shows commit hashes, file additions/deletions, change types, and impact levels with visual indicators

'use client';

import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faFileCode, faPlus, faMinus } from '~/interfaces/web/lib/fontawesome';
