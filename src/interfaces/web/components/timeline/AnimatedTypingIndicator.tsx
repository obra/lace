// ABOUTME: Animated typing indicator with pulsing dots and agent-specific styling
// ABOUTME: Features breathing animation for avatar and sophisticated loading dot sequence
