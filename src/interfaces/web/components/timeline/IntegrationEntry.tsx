// ABOUTME: Integration entry component for external service notifications
// ABOUTME: Displays actions from Google Drive, Slack, GitHub, and other integrations

'use client';

import React from 'react';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faExternalLinkAlt } from '~/interfaces/web/lib/fontawesome';
