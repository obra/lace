// ABOUTME: Timeline message component for displaying different types of conversation entries
// ABOUTME: Handles user messages, AI responses, tool calls, and integration notifications
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="bg-base-100 border border-base-300 rounded-lg p-4 shadow-sm">
            <h3 className="font-semibold text-base-content mb-3">{entry.title}</h3>
