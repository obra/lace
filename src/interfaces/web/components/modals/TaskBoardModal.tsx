// ABOUTME: Kanban-style task board modal for project task management
// ABOUTME: Provides drag-and-drop task organization with status columns

'use client';

import { useState } from 'react';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faPlus, faTasks, faUser } from '~/interfaces/web/lib/fontawesome';
import { Modal } from '~/interfaces/web/components/ui/Modal';
import { Task } from '~/interfaces/web/types';
