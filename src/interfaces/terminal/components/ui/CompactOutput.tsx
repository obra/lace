...
function truncateToLines(lines: string[], maxLines: number): { 
...
export function CompactOutput({ 
  ...
  const { truncatedLines, totalLines, isTruncated } = truncateToLines(lines, isExpanded ? lines.length : maxLines);
