...
program
  ...
  .option('--activity-log-path <path>', 'path to activity log database', '.lace/activity.db')
  .option('--log-level <level>', 'console log level (debug|info|warn|error|off)', 'off')
  .option('--log-file <path>', 'log file path for debug output')
  .option('--log-file-level <level>', 'file log level (debug|info|warn|error|off)', 'debug')
