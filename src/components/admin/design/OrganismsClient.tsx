...
import { faSearch, faTerminal, faTasks, faUser, faRobot, faCog, faPlus, faCheck, faStop, faFolder } from '~/lib/fontawesome';
import { ChevronDownIcon, ChevronRightIcon, XMarkIcon, Bars3Icon } from '@heroicons/react/24/outline';
import { motion, AnimatePresence } from 'framer-motion';

// Import our molecules to show composition examples
import { 
  NavigationItem, 
  MessageBubble, 
  ExpandableHeader 
...
export function OrganismsClient() {
  ...
  return (
    <div className="bg-base-100 rounded-lg border border-base-300">
      <div className="flex border-b border-base-300 overflow-x-auto">
        {[
          { id: 'composed', label: 'Composed Organisms', desc: 'Built from our molecules' },
      ...
      <div className="p-6">
        ...
        {activeTab === 'composed' && (
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-xl font-bold text-base-content mb-4">Sidebar Organism</h3>
              <p className="text-base-content/70 mb-6">
                A complete sidebar composed from NavigationItem molecules and ExpandableHeader molecules.
                Shows how complex navigation structures emerge from simple, reusable components.
              </p>

              <div className="grid lg:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-base-content mb-3">Composed Sidebar</h4>
                  <div className="border border-base-300 rounded-lg p-4 bg-base-100 max-w-72">
                    {/* Logo/Header */}
                    <div className="pb-4 border-b border-base-300 mb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-primary rounded-md flex items-center justify-center">
                          <span className="text-primary-content font-bold text-sm">L</span>
                        </div>
                        <span className="font-bold text-base-content">Lace</span>
                      </div>
                    </div>
                ...
                <div>
                  <h4 className="font-semibold text-base-content mb-3">Atomic Composition</h4>
                  <div className="space-y-4 text-sm">
                    <div className="p-4 border border-base-300 rounded bg-base-200">
                      <h5 className="font-semibold mb-2">Molecular Building Blocks:</h5>
                      <div className="space-y-1">
                        <div>• <span className="text-primary">NavigationItem</span> × 8 instances</div>
                        <div>• <span className="text-secondary">ExpandableHeader</span> × 2 instances</div>
                        <div>• Standard layout containers</div>
                      </div>
                    </div>
                    
                    <div className="p-4 border border-teal-200 rounded bg-teal-50">
                      <h5 className="font-semibold text-teal-800 mb-2">Benefits of Composition:</h5>
                      <div className="space-y-1 text-teal-700">
                        <div>• <strong>Consistent:</strong> All nav items look and behave the same</div>
                        <div>• <strong>Maintainable:</strong> Change NavigationItem, update everywhere</div>
                        <div>• <strong>Testable:</strong> Each molecule tested independently</div>
                        <div>• <strong>Flexible:</strong> Easy to add/remove sections</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Timeline Organism Example */}
            <div>
              <h3 className="text-xl font-bold text-base-content mb-4">Timeline Organism</h3>
              <p className="text-base-content/70 mb-6">
                A conversation timeline composed from MessageBubble molecules. Shows how different message types
                share the same structural pattern while displaying different content.
              </p>

              <div className="grid lg:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-base-content mb-3">Composed Timeline</h4>
                  <div className="border border-base-300 rounded-lg p-4 bg-base-100 space-y-4 max-h-96 overflow-y-auto">
                    <MessageBubble
                      role="user"
                      header={{
                        name: "You",
                    ...
                    >
                      Can you help me refactor my React component to use atomic design principles?
                    </MessageBubble>
                    ...
                    >
                      I'll help you refactor using atomic design! Let me first examine your component structure.
                    </MessageBubble>
                    ...
                    >
                      Found TimelineMessage.tsx (348 lines) - good candidate for atomic refactoring
                    </MessageBubble>
                    ...
                    >
                      Perfect! I can see your TimelineMessage component is doing too much. Let's break it into molecules like HumanMessage, AIMessage, and ToolMessage, each using the MessageBubble molecule as their foundation.
                    </MessageBubble>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4 text-sm">
                    <div className="p-4 border border-base-300 rounded bg-base-200">
                      <h5 className="font-semibold mb-2">Molecular Building Blocks:</h5>
                      <div className="space-y-1">
                        <div>• <span className="text-primary">MessageBubble</span> × 4 instances</div>
                        <div>• Different roles: user, assistant, system</div>
                        <div>• Each uses Avatar + Badge + StatusDot atoms</div>
                      </div>
                    </div>
                    
                    <div className="p-4 border border-teal-200 rounded bg-teal-50">
                      <h5 className="font-semibold text-teal-800 mb-2">Refactoring Impact:</h5>
                      <div className="space-y-1 text-teal-700">
                        <div>• <strong>Before:</strong> 348-line switch statement</div>
                        <div>• <strong>After:</strong> &lt;50 lines using MessageBubble</div>
                        <div>• <strong>Result:</strong> Reusable message types</div>
                        <div>• <strong>Benefit:</strong> Consistent message styling</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 rounded-lg border border-teal-200 p-6">
              <h3 className="text-xl font-bold text-teal-800 mb-4">🔄 Organism Refactoring Strategy</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-teal-700 mb-3">Current State Analysis</h4>
                  <div className="space-y-2 text-sm text-teal-700">
                    <div>• <strong>TimelineMessage:</strong> 348 lines → needs molecular composition</div>
                    <div>• <strong>Sidebar:</strong> 400+ lines → needs NavigationItem molecules</div>
                    <div>• <strong>EnhancedChatInput:</strong> 320 lines → needs form molecules</div>
                    <div>• <strong>Modal systems:</strong> Mix concerns → needs organism separation</div>
                  </div>
                </div>
                <div>
                  <h4 className="font-semibold text-teal-700 mb-3">Refactoring Approach</h4>
                  <div className="space-y-2 text-sm text-teal-700">
                    <div>• <strong>Identify:</strong> Repeated patterns within components</div>
                    <div>• <strong>Extract:</strong> Create specific molecules for each pattern</div>
                    <div>• <strong>Compose:</strong> Rebuild organisms from molecules</div>
                    <div>• <strong>Test:</strong> Verify each level works independently</div>
                  </div>
                </div>
              </div>
              
              <div className="mt-4 p-3 bg-teal-600 text-white rounded">
                <strong>Success Metric:</strong> If you can't easily see the molecular structure in an organism, it needs refactoring.
              </div>
            </div>
          </div>
        )}
