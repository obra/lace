...
Add a `session_info_update` variant to the existing `SessionUpdate` to allow dynamic session identification in client UIs.
...
3. **Protocol inconsistency** - Other dynamic properties use notifications, but metadata has none
