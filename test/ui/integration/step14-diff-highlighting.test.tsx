...
\`\`\``
    ...
    expect(textContent).toContain('\x1b[32m+  // Added one to the calculation\x1b[0m'); // Green addition line
  });
...
\`\`\``
    ...
    expect(textContent).toContain('\x1b[31m-  console.log(\'Processing...\');\x1b[0m');
    expect(textContent).toContain('\x1b[32m+  console.log(\'Processing data...\');\x1b[0m');
  });
...
\`\`\``
    ...
    expect(textContent).toContain('\x1b[32m+    this.version = \'1.0.0\';\x1b[0m');
  });
