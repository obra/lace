 ...
 */
function hydrateEvent(event: LaceEvent): LaceEvent {
  return {
    ...event,
 ...
 */
function hasDateTimestamp(event: LaceEvent): boolean {
 ...
 */
function _allEventsHaveDateTimestamps(events: LaceEvent[]): boolean {
