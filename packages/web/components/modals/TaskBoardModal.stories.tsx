...
const sampleTasks: Task[] = [
  {
    ...
    assignedTo: 'Claude',
    status: 'in_progress',
    createdBy: 'thread-001' as any,
    threadId: 'thread-001' as any,
  ...
  },
  {
    ...
    assignedTo: 'Human',
    status: 'pending',
    createdBy: 'thread-002' as any,
    threadId: 'thread-002' as any,
  ...
  },
  {
    ...
    assignedTo: 'Claude',
    status: 'blocked',
    createdBy: 'thread-003' as any,
    threadId: 'thread-003' as any,
  ...
  },
  {
    ...
    assignedTo: 'Human',
    status: 'pending',
    createdBy: 'thread-004' as any,
    threadId: 'thread-004' as any,
  ...
  },
  {
    ...
    assignedTo: 'Claude',
    status: 'completed',
    createdBy: 'thread-005' as any,
    threadId: 'thread-005' as any,
  ...
  },
  {
    ...
    assignedTo: 'Human',
    status: 'blocked',
    createdBy: 'thread-006' as any,
    threadId: 'thread-006' as any,
  ...
  },
  {
    ...
    assignedTo: 'Claude',
    status: 'completed',
    createdBy: 'thread-007' as any,
    threadId: 'thread-007' as any,
  ...
  },
  {
    ...
    assignedTo: 'Human',
    status: 'pending',
    createdBy: 'thread-008' as any,
    threadId: 'thread-008' as any,
...
const minimalTasks: Task[] = [
  {
    ...
    assignedTo: 'Claude',
    status: 'in_progress',
    createdBy: 'thread-minimal-001' as any,
    threadId: 'thread-minimal-001' as any,
  ...
  },
  {
    ...
    assignedTo: 'Human',
    status: 'pending',
    createdBy: 'thread-minimal-002' as any,
    threadId: 'thread-minimal-002' as any,
  ...
  args: {
    ...
    tasks: [
      ...Array.from({ length: 3 }, (_, i) => ({
        ...
        createdBy: `thread-high-${i + 1}` as any,
        threadId: `thread-high-${i + 1}` as any,
      ...
      ...Array.from({ length: 4 }, (_, i) => ({
        ...
        createdBy: `thread-medium-${i + 1}` as any,
        threadId: `thread-medium-${i + 1}` as any,
      ...
      ...Array.from({ length: 2 }, (_, i) => ({
        ...
        createdBy: `thread-low-${i + 1}` as any,
        threadId: `thread-low-${i + 1}` as any,
