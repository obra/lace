...
const minimalTasks: Task[] = [
  {
    ...
    assignedTo: 'Claude',
    status: 'in_progress',
    createdBy: 'thread-minimal-001',
    threadId: 'thread-minimal-001',
  ...
  },
  {
    ...
    assignedTo: 'Human',
    status: 'pending',
    createdBy: 'thread-minimal-002',
    threadId: 'thread-minimal-002',
  ...
  args: {
    ...
    tasks: [
      ...Array.from({ length: 3 }, (_, i) => ({
        ...
        createdBy: `thread-high-${i + 1}`,
        threadId: `thread-high-${i + 1}`,
      ...
      ...Array.from({ length: 4 }, (_, i) => ({
        ...
        createdBy: `thread-medium-${i + 1}`,
        threadId: `thread-medium-${i + 1}`,
      ...
      ...Array.from({ length: 2 }, (_, i) => ({
        ...
        createdBy: `thread-low-${i + 1}`,
        threadId: `thread-low-${i + 1}`,
