...
const sampleTasks: Task[] = [
  {
    ...
    priority: 'high',
    assignedTo: 'claude-agent-thread',
    createdBy: 'mobile-session-thread',
    threadId: 'mobile-session',
    status: 'in_progress',
  ...
  args: {
    ...
    activeTasks: [
      ...
      ...Array.from({ length: 5 }, (_, i) => ({
        ...
        assignedTo: (['claude-agent', 'human-user'] as const)[i % 2] as string,
        createdBy: 'session-main',
