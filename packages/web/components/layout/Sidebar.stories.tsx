...
const mockTasks: Task[] = [
  ...
  },
  {
    ...
    status: 'pending',
    assignee: 'GPT-4',
    created: new Date('2024-01-14T13:00:00Z'),
    deadline: new Date('2024-01-18T17:00:00Z'),
  },
  {
    id: '3',
    ...
    deadline: new Date('2024-01-17T17:00:00Z'),
  },
];
    ...
    <SidebarWrapper
      activeTasks={[
        ...mockTasks,
        {
          ...
          deadline: new Date('2024-01-19T17:00:00Z'),
        },
        {
          id: '5',
          ...
          deadline: new Date('2024-01-22T17:00:00Z'),
        },
      ]}
    />
  ),
