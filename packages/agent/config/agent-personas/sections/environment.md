...
- Current Branch: {{git.branch}} {{/git.branch}} {{#git.status}}
- Repository Status: {{git.status}} {{/git.status}} {{#git.user.name}}
- Git User: {{git.user.name}} <{{git.user.email}}> {{/git.user.name}}
